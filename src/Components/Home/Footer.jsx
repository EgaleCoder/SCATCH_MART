export default function Footer() {
  return (
    <footer className="py-6 bg-black w-full text-white">
      <div className="mx-6 space-y-6 divide-y divide-black-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          <div className="col-span-full md:pb-0 md:col-span-4">
            ...
            >
              ...
              <span className="self-center text-2xl font-semibold">SCATCH</span>
            </a>
          </div>
        ...
        <div className="grid justify-center lg:justify-between">
          ...
          <div className="flex justify-center pt-2 space-x-4 lg:pt-0 lg:col-end-13">
            <a
              href="#"
              title="Email"
